...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo bindingValidError(HttpServletRequest req, Exception e) {
        ...
        return logAndGetErrorInfo(req, e, false, VALIDATION_ERROR, detailsList.toArray(new String[0]));
    }
